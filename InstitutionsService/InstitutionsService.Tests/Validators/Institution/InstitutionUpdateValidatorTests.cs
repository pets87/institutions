...
{
    [TestClass]
    public class InstitutionUpdateValidatorTests
    {
        private InstitutionUpdateValidator validator;

        [TestInitialize]
        public void Setup()
        {
            validator = new InstitutionUpdateValidator();
        }
        ...
        [TestMethod]
        public void IsValid_InstitutionIsWithoutId_ReturnsFalse()
        {
            InstitutionsService.Models.Institution institution = new InstitutionsService.Models.Institution();

            var result = validator.IsValid(institution);

            Assert.IsFalse(result);
            Assert.AreEqual("Institution object must have Id.", validator.ErrorMessage);
        }

        [TestMethod]
        public void IsValid_NameIsNull_ReturnsFalse()
        {
            var institution = new InstitutionsService.Models.Institution { Id= 1, Name = null };
        ...
        {
            var institution = new InstitutionsService.Models.Institution { Id = 1, Name = "Institution1", RegCode = null };
        ...
        {
            var institution = new InstitutionsService.Models.Institution { Id = 1, Name = "Institution1", RegCode = "123", TypeClassifierId = 0 };
        ...
        {
            var institution = new InstitutionsService.Models.Institution { Id = 1, Name = "Institution1", RegCode = "123", TypeClassifierId = 1, AddressId = 0 };
        ...
        {
            var institution = new InstitutionsService.Models.Institution { Id = 1, Name = "Institution1", RegCode = "123", TypeClassifierId = 1, AddressId = 1 };
        ...
        {
            var institution = new InstitutionsService.Models.Institution { Id = 1, Name = "Institution1", RegCode = "123", TypeClassifierId = 1, AddressId = 1, ValidFrom = DateTime.MinValue };
